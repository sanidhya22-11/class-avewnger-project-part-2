...
if(keyPressed == '71') {  new_image('spiderman_legs.png'); console.log("f"); }
...
if(keyPressed == '71') {  new_image('iromman_right_hand.png'); console.log("f"); }
...
if(keyPressed == '71') {  new_image('captain_america_left_hand.png'); console.log("f"); }
